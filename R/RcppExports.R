...
GetDivisorsC <- function(Rv, RNamed, RNumThreads, maxThreads, RShowStats, RSkipExtPR) {
    .Call(`_RcppBigIntAlgos_GetDivisorsC`, Rv, RNamed, RNumThreads, maxThreads, RShowStats, RSkipExtPR)
}
