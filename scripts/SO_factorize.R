reprex::reprex({
    ...
    #'
    #' And here are the benchmarks as defined in my original post (N.B. `MyFactors` is replaced by `divisorsRcpp` and `divisorsBig`).
    #'
    ...
    microbenchmark(
        divisorsBig(negPowTen),
        all_divisors(negPowTen),
        unit = "relative"
    )
